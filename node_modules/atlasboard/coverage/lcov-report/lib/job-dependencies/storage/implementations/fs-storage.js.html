...
<html lang="en">
<head>
    <title>Code coverage report for lib/job-dependencies/storage/implementations/fs-storage.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/job-dependencies/storage/implementations/fs-storage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/job-dependencies/storage/implementations/</a> &#187; fs-storage.js</div>
</div>
<div class="body">
...
function StorageFS(storageKey, options){
  ...
  this.storagePath = options.storagePath || <span class="branch-1 cbranch-no" title="branch not covered" >path.join(process.cwd(), "/job-data-storage.json");</span>
}
&nbsp;
...
StorageFS.prototype.get = function (key, callback){
  ...
  fs.readFile(self.storagePath, function (err, data){
    ...
    try {
      ...
      data = content[self.storageKey] ? content[self.storageKey][key].data : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    }
    catch(e){
...
&nbsp;
module.exports = StorageFS;</pre></td></tr>
</table></pre>
