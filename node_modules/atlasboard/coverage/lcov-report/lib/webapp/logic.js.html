...
<html lang="en">
<head>
    <title>Code coverage report for lib/webapp/logic.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/webapp/logic.js</span></h1>
    <h2>
        
        Statements: <span class="metric">91.46% <small>(75 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/webapp/</a> &#187; logic.js</div>
</div>
<div class="body">
...
function addNamespace (css, res, widgetNamespace){
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (css){
    var parse = require('css-parse');
    var parsedNamespaceCss = parse(css);
    parsedNamespaceCss.stylesheet.rules.forEach(function(rule) {
      rule.selectors.forEach(function (selector) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (!rule.declarations){
<span class="cstat-no" title="statement not covered" >          logger.error('Error. No CSS declaration for selector ' + selector + ' in widget ' + widgetNamespace); </span>// don't put comments within the rules!
        }
        else {
...
<span class="cstat-no" title="statement not covered" >          return res.send(400, "Error loading dashboards");</span>
        }
...
&nbsp;
    ...
    renderDashboard : function (packagesPath, dashboardName, req, res){
      ...
      itemManager.get_first(packagesPath, dashboardName, "dashboards", ".json", function(err, dashboard){
        if (err || !dashboard){
          return res.send(err ? <span class="branch-0 cbranch-no" title="branch not covered" >400 </span>: 404, err ? <span class="branch-0 cbranch-no" title="branch not covered" >err </span>: "Trying to render dashboard " + dashboardName + ", but couldn't find any dashboard in the packages folder");
        }
        var jsonBody;
        try {
...
<span class="cstat-no" title="statement not covered" >          return res.send(400, "Invalid dashboard config file");</span>
        }
...
<span class="cstat-no" title="statement not covered" >          return res.send(400, "Error reading dashboard");</span>
        }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken"" >E</span>if (fs.existsSync(resourcePath)){
        res.sendfile(resourcePath);
      }
      else {
<span class="cstat-no" title="statement not covered" >        return res.send(404, 'resource not found');</span>
      }
    },
&nbsp;
    // ---------------------------------------------------------------
    ...
    renderJsWidget: function (packagesPath, widgetName, req, res){
      ...
      itemManager.get_first(packagesPath, widgetName, "widgets", ".js", function(err, html_file){
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (err || !html_file){
<span class="cstat-no" title="statement not covered" >          return res.send(400, "Error rendering widget");</span>
        }
...
&nbsp;
   /**
    * Return HTML for a specific widgetName
    *
    * @param {[string]} packagesPath : list of directories to find packages in.
    * @param {string} widgetName item name to match. It can be namespaced. i.e: atlassian#widget1, widget1
    */
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jul 26 2013 15:45:36 GMT+1000 (EST)</div>
</div>
