...
<html lang="en">
<head>
    <title>Code coverage report for lib/hipchat.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/hipchat.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; hipchat.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var api_url = 'https://api.hipchat.com/v1',
    qstring = require('querystring');
&nbsp;
module.exports.create = function(options) {
  var request = options.request || <span class="branch-1 cbranch-no" title="branch not covered" >require ('request');</span>
&nbsp;
  if (!options.api_key){
...
&nbsp;
  return {
    ...
    'message' : function (roomId, from, message, notify, callback){
      var url = api_url + '/rooms/message?format=json&amp;auth_token=' + options.api_key;
&nbsp;
