...
<html lang="en">
<head>
    <title>Code coverage report for lib/package-dependency-manager.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/package-dependency-manager.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; package-dependency-manager.js</div>
</div>
<div class="body">
...
&nbsp;
    getValidPackageJSON(atlasboardPackageJsonPath, function(err, atlasboardPackageJson){
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (err) { <span class="cstat-no" title="statement not covered" >return callback('package.json not found for atlasboard at ' + atlasboardPackageJsonPath); </span>}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      callback('Error installing dependencies for ' + pathPackageJson + '. err:' + err);</span>
      ...
      callback(code !== 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >'error installing ' + pathPackageJson </span>: null);
    }
  });
&nbsp;
...
function executeCommand(cmd, args, callback) {
  ...
  child.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span>
